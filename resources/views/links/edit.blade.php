            ...
            <div class="card">
                <div class="card-header card-header-icon card-header-secondary">
                    ...
                    <h4 class="card-title">Hospital
                        <small class="category">Editar</small>
                    </h4>
                </div>
                <form method="post" action="{{ route('hospitais.update')}}">
                    @csrf
                    @method('POST')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="col-12 m-0 p-0" id="image">
                                    <img src="{{ asset($hospital->image??'images/hosptal.png') }}" id="imagemImage" class="rounded mx-auto d-block img-fluid" alt="...">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nome" value="{{ $hospital->nome }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="telefone1" id="tel1" value="{{ $hospital->telefone1 }}" />
                                    </div>
                                    
                                    <div class="col-md-4">
                                        <label class="bmd-label-static">Telefone 2</label>
                                        <input type="text" class="form-control" name="telefone2" id="tel2" value="{{ $hospital->telefone2 }}" />
                                    </div>
                                    
                                    <div class="col-md-4">
                                        <label class="bmd-label-static">Cidade</label>
                                        <input type="text" class="form-control" name="cidade" id="cidade" value="{{ $hospital->cidade }}"/>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="endereco" id="endereco" value="{{ $hospital->endereco }}"/>
                                    </div>
                                </div>
                                ...
                                <div class="row my-5">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control col-md-12" rows="5" name="obs" id="obs">{{ $hospital->obs }}</textarea>
                                    </div>
                                </div> 
